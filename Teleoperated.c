 ...
 * Test lift presets
 * Add the encoder target for the lift high goal
 * Write driveUntilTicks function body
 * Tune acceptableDriveError and acceptableLiftError
 * Tune kPLift and kPDrive/kIDrive/kDDrive
 */
